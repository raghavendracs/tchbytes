    ...
    return (
      <React.Fragment>
        <Helmet>
          ...
          {_.get(this.props, 'pageContext.frontmatter.template') === 'post' && _.get(this.props, 'pageContext.frontmatter.canonical_url') && 
            <link rel='canonical' href={_.get(this.props, 'pageContext.frontmatter.canonical_url')} />
          }
        </Helmet>
        <div
          id='page'
          className={`site layout-${_.get(this.props, 'pageContext.site.siteMetadata.layout_style')} palette-${_.get(
            this.props,
