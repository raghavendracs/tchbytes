    ...
    return (
      <Layout {...this.props}>
        {_.map(_.get(this.props, 'pageContext.frontmatter.sections'), (section, section_idx) => {
          ...
          return <GetSectionComponent key={section_idx} {...this.props} section={section} site={this.props.pageContext.site} />;
        })}
                ...
                <div className='post-card-content'>
                  ...
                  <div className='post-excerpt'>
                    ...
                    <p className='read-more'>
                      <Link className='button inverse' to={safePrefix(_.get(post, 'url'))}>
                        Read more
                      </Link>
                    </p>
                  </div>
