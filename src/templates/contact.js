      ...
      <Layout {...this.props}>
        <article className='post page post-full'>
          ...
          {_.get(this.props, 'pageContext.frontmatter.subtitle') && 
            <div className='post-subtitle'>{htmlToReact(_.get(this.props, 'pageContext.frontmatter.subtitle'))}</div>
          }
          {_.get(this.props, 'pageContext.frontmatter.img_path') && 
            <div className='post-thumbnail'>
              <img
                className='thumbnail'
                src={safePrefix(_.get(this.props, 'pageContext.frontmatter.img_path'))}
          ...
          <div className='post-content'>
            ...
            <form name='contactForm' method='POST' netlifyHoneypot='bot-field' data-netlify='true' id='contact-form' className='contact-form'>
